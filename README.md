...
- **설명**: 콜센터 음성의 샘플레이트·채널·샘플 폭을 확인하고, 993건 규모의 음성을 직접 청취해 30초를 넘는 파일을 중간 묵음 지점에서 수동 분할했습니다. 묵음 구간에서 발생하는 특수문자와 앞 문장 반복 문제를 줄인 뒤 Whisper 모델 비교·파인튜닝·후처리 실험을 수행했습니다.
